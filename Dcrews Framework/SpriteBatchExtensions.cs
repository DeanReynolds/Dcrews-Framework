...
namespace Microsoft.Xna.Framework.Graphics
{
    ...
    public static class SpriteBatchExtensions
    {
        ...
        public static void FillRectangle(this SpriteBatch s, Rectangle rect, Color color, float rotation = 0, float layer = 0) => s.Draw(Pixel, rect.Center.ToVector2(), null, color, rotation, PixelOrigin, new Vector2(rect.Width, rect.Height), 0, layer);
